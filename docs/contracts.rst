...
exists to limit the gas costs of returning an entire array. You can use
...
Before executing the constructor code the compiler always generates code to
represent the initial storage state. It initialises any state variables you
declare to their specified default value if you initialise them inline, or zero
if you do not.

After that it returns the final code of the contract. The final deployment of
...
then an "out of gas" exception is generated. This is the **only** situation
